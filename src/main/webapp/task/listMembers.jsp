    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align: center; min-width: 40px;"><a href="${contextPath}/jw/task/member/modMemberForm.do?uid=${mem.uid }">수정</a></td>
          <td style="text-align: center; min-width: 40px;"><a href="${contextPath}/jw/task/member/delMember.do?uid=${mem.uid }">삭제</a>
          </td>
        </tr>
		</c:forEach>
		</c:when>
